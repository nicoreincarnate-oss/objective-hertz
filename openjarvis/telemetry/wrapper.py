...
def instrumented_generate(
    ...
    **kwargs: Any,
    ...
    # Derive throughput if we have completion tokens and latency
    throughput = completion_tokens / latency if latency > 0 and completion_tokens else 0.0
    ...
    rec = TelemetryRecord(
        ...
        energy_joules=result.get("energy_joules", 0.0),
