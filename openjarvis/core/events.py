...
class EventType(str, Enum):
    ...
    # Phase 30 — Vassal / Empire integration
    A2A_REMOTE_EVENT = "a2a_remote_event"
    A2A_VASSAL_DISCOVERED = "a2a_vassal_discovered"
    A2A_VASSAL_UNREACHABLE = "a2a_vassal_unreachable"
    BUDGET_WARNING = "budget_warning"
    BUDGET_EXCEEDED = "budget_exceeded"
    BUDGET_OK = "budget_ok"
    REVIEW_GATE_PENDING = "review_gate_pending"
    REVIEW_GATE_APPROVED = "review_gate_approved"
